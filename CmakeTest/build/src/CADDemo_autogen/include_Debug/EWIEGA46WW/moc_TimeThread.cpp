...
QT_MOC_LITERAL(4, 29, 10) // "authRemind"

    },
    "TimeThread\0timeChanged\0\0time\0authRemind"
};
...
void TimeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->authRemind(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TimeThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeThread::timeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TimeThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeThread::authRemind)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TimeThread::timeChanged(const QString & _t1)
{
